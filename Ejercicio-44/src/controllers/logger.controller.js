...
const loggerBase = winston.createLogger({
    transports: [
        ...
        new winston.transports.File({ filename: './Ejercicio-44/loggers/errors.log', level: 'warn' }) //Para el caso de File, se visualizaran desde warn (1) hasta error (0), y se veran en un archivo .log con la ruta especificada
    ]
});
