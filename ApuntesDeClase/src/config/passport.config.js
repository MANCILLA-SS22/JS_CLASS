...
function initialPassport(){ //Inicializando la estrategia local, username sera para nosotros email. Done será nuestro callback
    ...
    passport.use("regiter", new localStrategy( {passReqToCallback: true, usernameField: 'email'}, register ));
